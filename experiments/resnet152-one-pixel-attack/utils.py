...
def get_imagenet_data(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225], root='./imagenet-1k-mini/images', index='./imagenet-1k-mini/imagenet_class_index.json'):
    class_idx = json.load(open(index))
    ...
    imagnet_data = image_folder_custom_label(root=root, 
                                             transform=transform,
                                             idx2label=idx2label)
